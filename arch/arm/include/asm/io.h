...
#define __raw_writeb(v, a) \
	(__chk_io_ptr(a), *(volatile unsigned char __force  *)(a) = (v))
#define __raw_writew(v, a) \
	(__chk_io_ptr(a), *(volatile unsigned short __force *)(a) = (v))
#define __raw_writel(v, a) \
	(__chk_io_ptr(a), *(volatile unsigned int __force   *)(a) = (v))

#define __raw_readb(a) \
	(__chk_io_ptr(a), *(volatile unsigned char __force  *)(a))
#define __raw_readw(a) \
	(__chk_io_ptr(a), *(volatile unsigned short __force *)(a))
...
#define ioread16(p) \
	({ unsigned int __v = \
	le16_to_cpu((__force __le16)__raw_readw(p)); __iormb(); __v; })
#define ioread32(p) \
	({ unsigned int __v = \
	le32_to_cpu((__force __le32)__raw_readl(p)); __iormb(); __v; })

#define ioread16be(p) \
	({ unsigned int __v = \
	be16_to_cpu((__force __be16)__raw_readw(p)); __iormb(); __v; })
#define ioread32be(p) \
	({ unsigned int __v = \
	be32_to_cpu((__force __be32)__raw_readl(p)); __iormb(); __v; })

#define iowrite8(v, p)	({ __iowmb(); (void)__raw_writeb(v, p); })
#define iowrite16(v, p) \
	({ __iowmb(); (void)__raw_writew((__force __u16)cpu_to_le16(v), p); })
#define iowrite32(v, p) \
	({ __iowmb(); (void)__raw_writel((__force __u32)cpu_to_le32(v), p); })

#define iowrite16be(v, p) \
	({ __iowmb(); (void)__raw_writew((__force __u16)cpu_to_be16(v), p); })
#define iowrite32be(v, p) \
	({ __iowmb(); (void)__raw_writel((__force __u32)cpu_to_be32(v), p); })
