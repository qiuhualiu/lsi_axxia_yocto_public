#ifndef __ACP3400_RIO_IRQ_H__
#define __ACP3400_RIO_IRQ_H__
...
extern struct mutex acp3400_rio_api_mutex;

static inline void acp3400_api_lock(void)
{
	mutex_lock(&acp3400_rio_api_mutex);
}
static inline void acp3400_api_unlock(void)
{
	mutex_unlock(&acp3400_rio_api_mutex);
}
...
extern int acp3400_rio_init_sysfs(struct platform_device *dev);
extern void acp3400_rio_release_sysfs(struct platform_device *dev);
