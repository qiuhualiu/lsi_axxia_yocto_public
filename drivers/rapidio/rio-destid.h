...
extern int rio_pin_destid(struct rio_mport *mport, u16 parent_destid, int parent_port,
			  int hopcount);
extern int rio_unlock_destid(struct rio_mport *mport, u16 parent_destid, int parent_port,
			     int hopcount);

extern int rio_set_device_id(struct rio_mport *mport, u16 destid, u8 hopcount, u16 did);
extern int rio_assign_destid(struct rio_dev *rdev, struct rio_mport *port, u16 destid,
                             int hopcount, u16 *id);
...
extern int rio_dest_is_redundant(struct rio_mport *mport, u16 parent_destid, int parent_port,
				 int hopcount);
extern int rio_dest_is_legacy(struct rio_mport *mport, u16 parent_destid, int parent_port,
			      int hopcount);
extern int rio_dest_is_one_way(struct rio_mport *mport, u16 parent_destid, int parent_port,
			       int hopcount);

extern int rio_eval_destid(struct rio_dev *new_rdev);
extern int rio_get_destid(struct rio_mport *mport, u16 destid, u8 hopcount, u16 *res_destid);
extern int rio_read_comptag(struct rio_mport *mport, u16 destid, u8 hopcount, u32 *comptag);
...
extern int rio_get_return_port(struct rio_mport *mport, u16 parent_destid, int parent_port,
			       int hopcount, u8 *rport);
extern int rio_get_legacy_properties(struct rio_mport *mport, u16 parent_destid, int parent_port,
				     int hopcount, u8 *lock_hw, u8 *lut_update);
extern int rio_destid_get_parent_port(struct rio_mport *mport, u16 destid, u8 *port);
...
extern int rio_lookup_static_route(struct rio_dev *rdev, u16 sw_dest, u8 *route_port);
