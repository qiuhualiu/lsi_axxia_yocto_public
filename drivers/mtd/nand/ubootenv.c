...
#undef DEBUG_STATIC_SYMBOLS
/*#define DEBUG_STATIC_SYMBOLS*/
#ifdef DEBUG_STATIC_SYMBOLS
#define STATIC
#else
...
printk(KERN_DEBUG "ubootenv:%s:%d - DEBUG - ", __func__, __LINE__); \
printk(format, ##args); \
} while (0);
#else
...
printk(KERN_WARN "ubootenv:%s:%d - WARN - ", __func__, __LINE__); \
printk(format, ##args); \
} while (0);
#else
...
#ifdef DEBUG_STATIC_SYMBOLS
STATIC_SYMBOL(ubootenv_crc32);
#endif /* DEBUG_STATIC_SYMBOLS */
...
#ifdef DEBUG_STATIC_SYMBOLS
STATIC_SYMBOL(ubootenv_initialize);
#endif /* DEBUG_STATIC_SYMBOLS */
...
#ifdef DEBUG_STATIC_SYMBOLS
STATIC_SYMBOL(ubootenv_finalize);
#endif /* DEBUG_STATIC_SYMBOLS */
