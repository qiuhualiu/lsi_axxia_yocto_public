...
#define  RIO_PEF_EXT_RT	      0x00000200 /* [III] 1.3] Extd route tbl supt */
#define  RIO_PEF_STD_RT	      0x00000100 /* [III] 1.3] Strd route tbl supt */
...
#define  RIO_SWP_INFO_CAR		0x14	/* [I] Switch Port Info CAR */
#define  RIO_SWP_INFO_PORT_TOTAL_MASK	0x0000ff00  /* [I] Total # of ports */
#define  RIO_SWP_INFO_PORT_NUM_MASK	0x000000ff  /* [I] Maint TXN port # */
#define  RIO_GET_TOTAL_PORTS(x)	\
			((x & RIO_SWP_INFO_PORT_TOTAL_MASK) >> 8)
...
#define  RIO_SWITCH_RT_LIMIT		0x34  /* [III, 1.3] Switch Route Table
						Destination ID Limit CAR */
...
#define RIO_HOST_DID_LOCK_CSR	0x68    /* [III] Host Base Device ID Lck CSR */
...
#define RIO_EFB_SER_EP_ID_V13P	0x0001	/* [VI] LP/Serial EP Devices, RapidIO
						Spec ver 1.3 and above */
#define RIO_EFB_SER_EP_REC_ID_V13P	0x0002	/* [VI] LP/Serial EP Recovery
				Devices, RapidIO Spec ver 1.3 and above */
#define RIO_EFB_SER_EP_FREE_ID_V13P	0x0003	/* [VI] LP/Serial EP Free
				Devices, RapidIO Spec ver 1.3 and above */
#define RIO_EFB_SER_EP_ID	0x0004	/* [VI] LP/Serial EP Devices */
#define RIO_EFB_SER_EP_REC_ID	0x0005	/* [VI] LP/Serial EP Recovery
						Devices */
#define RIO_EFB_SER_EP_FREE_ID	0x0006	/* [VI] LP/Serial EP Free Devices */
#define RIO_EFB_SER_EP_FREC_ID	0x0009  /* [VI] LP/Serial EP Free Recovery
						Devices */
#define RIO_EFB_ERR_MGMNT	0x0007  /* [VIII] Error Management
						  Extensions */
...
/* NOTE: LTL = Logical Transport Layer */
#define RIO_EM_EFB_HEADER	0x000	/* Error Mgmnt Exten Block Header */
#define RIO_EM_LTL_ERR_DETECT	0x008	/* LTL Error Detect CSR */
#define RIO_EM_LTL_ERR_EN	0x00c	/* LTL Error Enable CSR */
...
#define RIO_EM_LTL_HIADDR_CAP	0x010	/* LTL High Address Capture CSR */
#define RIO_EM_LTL_ADDR_CAP	0x014	/* LTL Address Capture CSR */
#define RIO_EM_LTL_DEVID_CAP	0x018	/* LTL Device ID Capture CSR */
#define RIO_EM_LTL_CTRL_CAP	0x01c	/* LTL Control Capture CSR */
...
#define RIO_EM_PN_ERR_DETECT(x)	\
		(0x040 + x*0x40) /* Port N Error Detect CSR */
#define  REM_PED_IMPL_SPEC	0x80000000
#define  REM_PED_LINK_TO	0x00000001
#define RIO_EM_PN_ERRRATE_EN(x) \
		(0x044 + x*0x40) /* Port N Error Rate Enable CSR */
#define RIO_EM_PN_ATTRIB_CAP(x)	\
		(0x048 + x*0x40) /* Port N Attributes Capture CSR */
#define RIO_EM_PN_PKT_CAP_0(x)	\
		(0x04c + x*0x40) /* Port N Pckt/Control Symbol Capture 0 CSR */
#define RIO_EM_PN_PKT_CAP_1(x)	\
		(0x050 + x*0x40) /* Port N Packet Capture 1 CSR */
#define RIO_EM_PN_PKT_CAP_2(x)	\
		(0x054 + x*0x40) /* Port N Packet Capture 2 CSR */
#define RIO_EM_PN_PKT_CAP_3(x)	\
		(0x058 + x*0x40) /* Port N Packet Capture 3 CSR */
#define RIO_EM_PN_ERRRATE(x)	\
		(0x068 + x*0x40) /* Port N Error Rate CSR */
#define RIO_EM_PN_ERRRATE_TR(x) \
		(0x06c + x*0x40) /* Port N Error Rate Threshold CSR */
