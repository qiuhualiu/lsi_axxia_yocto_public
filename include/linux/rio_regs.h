...
#define  RIO_PEF_CRFS			0x00000020	/* [III] Critical Request Flow Support */
...
#define  RIO_MASK_CMD_DEL_ALL_PORTS	(0x4 << 4)	/* Delete All Ports Command */
#define  RIO_MASK_CMD_ADD_ALL_PORTS	(0x5 << 4)	/* Add All Ports Command */
#define  RIO_MCAST_PORT_PRESENT		(0x00000001)	/* Port Present from Write to Verify command */

#define RIO_MCAST_ASSOC_SEL_CSR 0x84	/* Multicast Association Selection CSR */
#define  RIO_MCAST_LARGE_DEST_ID(x)	((x) << 24)	/* Large Destination Id */
#define  RIO_MCAST_DEST_ID(x)		((x) << 16)	/* Destination Id */
#define  RIO_MCAST_MASK_NO(x)		(x)		/* Multicast Mask Number */

#define RIO_MCAST_ASSOC_OP_CSR  0x88	/* Multicast Association Operation CSR */
